...
function ending(){popup('<div class="eyebrow">PROLOG ABGESCHLOSSEN</div><h2>Nächster Halt: ganz oben.</h2><p>Der Motor hustet, fängt sich und läuft. Du zupfst deinen schwarzen Anzug zurecht. Im Rückspiegel wird der Hof langsam kleiner.</p><p>In deiner Tasche steckt die Adresse deines Onkels.<br>Auf dem Brief steht: <em>„Personaleingang hinten.“</em></p><p>Fortsetzung: Akt 1 · Herzlich willkommen.</p>','Zurück zum Hof');}
